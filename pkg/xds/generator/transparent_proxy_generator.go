...
func (tpg TransparentProxyGenerator) Generate(_ context.Context, _ *model.ResourceSet, xdsCtx xds_context.Context, proxy *model.Proxy) (*model.ResourceSet, error) {
	...
	// If the dataplane  is using an older version of Kuma (where IP family mode was not
	// specified) but the control plane is using a current version, IPv6 will be disabled
	// and the configuration won't be applied. In such cases, the RedirectPortInboundV6
	// will be ignored.
