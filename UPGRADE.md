...
In Universal mode, installing transparent proxy:
...
Using the annotation on Kubernetes workloads:
...
For more information about disabling IPv6 in transparent proxy redirection, visit our documentation: https://kuma.io/docs/2.8.x/production/dp-config/ipv6/#disabling-ipv6

Please update your configurations accordingly to ensure a smooth transition and to avoid any disruptions in your service.
